...
I am not yet willing to give up, and I therefore propose to explore a
 compromise semantics based on a careful theoretical exploration of the design
 space.
...
\begin{figure}[t]
  \begin{tikzpicture}[text centered]
    ...
    \node (1) [align=center,below of=0,yshift=1mm,xshift=-2in] {improve an existing\\compiler~\cite{gtnffvf-jfp-2019,fgsfs-oopsla-2018}};
    \node (4) [align=center,below of=0,yshift=0mm,xshift= 2in,draw,dashed,ellipse,outer sep=2pt] {interoperate with a\\weakened semantics};
    \node (2) [align=center,right of=1,yshift=-9mm,xshift=20mm] {build a new\\compiler~\cite{bbst-oopsla-2017}};
    \node (3) [align=center,left of=4,yshift=-10mm,xshift=-18mm] {design a new language~\cite{mt-oopsla-2017,kas-pldi-2019,rat-oopsla-2017}};
