...
\newcommand{\deftablemacros}{%
  ...
  \newcommand{\hsep}{\quad\qquad}
  \newcommand{\offsetbox}[1]{\zerowidth{\quad ##1}}
...
\newcommand{\grantnum}[2]{{\small\tt #2}}
