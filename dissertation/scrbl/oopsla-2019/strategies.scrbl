...
@; @section{@|nname|}
@; \label{sec:design:strat:natural}
@; 
...
@; 
@; 
@; @subsection{Theoretical Costs, Motivation for Alternative Methods}
@; \label{sec:design:strat:performance}
@; 
...
@; 
@; The name ``@|nname|'' comes from \cite{mf-toplas-2009}, who use it
...
@; 
@; @section{@|cname|}
@; \label{sec:design:strat:conatural}
@; 
...
@; \cite{fgr-ifl-2007} implement exactly this strategy for Racket struct contracts.
...
@; 
@; @section{@|fname|}
@; \label{sec:design:strat:forgetful}
@; 
...
@; 
@; \cite{g-popl-2015} introduces forgetful manifest contracts and proves
...
@;  abstraction and information hiding.\footnote{\shorturl{https://}{arxiv.org/abs/1410.2813}}
@; \cite{cl-icfp-2017} present a forgetful and type sound semantics for a
...
@; 
@; @ection{@|tname|}
@; \label{sec:design:strat:transient}
@; 
...
@; \cite{gf-icfp-2018} supply additional comments and performance data regarding an
...
@; 
@; \cite{v-thesis-2019} invented @|tname|.
...
@; 
@; @section{@|aname|}
@; \label{sec:design:strat:amnesic}
@; 
...
@; 
@; @section{@|ename|}
@; \label{sec:design:strat:erasure}
@; 
